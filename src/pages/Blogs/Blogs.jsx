            ...
            <div className='w-10/12 lg:w-8/12 mx-auto mb-12'>
                ...
                <div className='rounded-md drop-shadow-2xl bg-slate-50 border-2 p-6'>
                    ...
                    <p className='mt-3 mb-10'>
                        ...
                        Since JavaScript doese not have a built-in type checking solution, many developers use extensions like TypeScript and Flow. However, React has an internal mechanism for props validation called PropTypes. In this article, we’ll learn how to validate props with React PropTypes.
                    </p>
                </div>
                ...
                <div className='rounded-md drop-shadow-2xl bg-slate-50 border-2 p-6'>
                    ...
                    <p className='mt-3 mb-10'>
                        ...
                        A custom hook is a features  in React, this is very important a popular JavaScript library for building user interfaces, that allows you to extract reusable logic from a component. It enables you to create a function that encapsulates common stateful logic and can be shared across multiple components.

                        In React, hooks are functions that lets you use state and other React features without writing a class. While React provides several built-in hooks like useState and useEffect, you can also create your own custom hooks to abstract and reuse specific logic.
                    </p>
                </div>
